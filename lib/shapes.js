...
class Circle extends Shape {
    ...
    // Returns the SVG Circle code that is expected based off the shape that was determined by the user
    returnSVG() {
...
// Creates a Square class which expects the length of each side of the square, shape color, text color, and the text included in the logo
class Square extends Shape {
    constructor(lengthOfSide, shapeColor, textColor, text) {
        // Super is used to call the constructor of the Shape class to define the constructor of the Square class to initialize these properties before adding the child classes own properties
        super(shapeColor, textColor, text)
        this.lengthOfSide = lengthOfSide;
    }
    // Returns the SVG Square code that is expected based off the shape that was determined by the user
    returnSVG() {
